...
impl MOpcode {
    ...
    fn info(&self) -> (Cow<str>, MArity) {
        match *self {
            ...
            MOpcode::OpUCall => (Cow::from("OpUCall"), MArity::Unary),
    ...
    pub fn idx(&self) -> u16 {
        match * self {
            ...
            MOpcode::OpCmp => 5,
            MOpcode::OpConst(_) => 6,
            MOpcode::OpCustom(_) => 7,
            MOpcode::OpDiv => 8,
            MOpcode::OpEq => 9,
            MOpcode::OpGt => 10,
            MOpcode::OpITE => 11,
            MOpcode::OpIf => 12,
            MOpcode::OpInvalid => 13,
            MOpcode::OpJmp => 14,
            MOpcode::OpLoad => 15,
            MOpcode::OpLsl => 16,
            MOpcode::OpLsr => 17,
            ...
            MOpcode::OpMod => 19,
            MOpcode::OpMul => 20,
            MOpcode::OpNarrow(_) => 21,
            MOpcode::OpNop => 22,
            MOpcode::OpNot => 23,
            MOpcode::OpOr => 24,
            MOpcode::OpRol => 25,
            MOpcode::OpRor => 26,
            MOpcode::OpSignExt(_) => 27,
            MOpcode::OpStore => 28,
            MOpcode::OpSub => 29,
            MOpcode::OpXor => 30,
            MOpcode::OpZeroExt(_) => 31,
            MOpcode::Invalid => 32,
        }
    }
}
